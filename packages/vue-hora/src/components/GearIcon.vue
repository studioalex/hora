...
<template>
  <svg
    ...
    class="hora__icon-gear"
    :class="customClass"
    viewBox="0 0 64 64">
    <circle data-name="layer2" cx="32" cy="32" r="14" fill="none" stroke="#202020" stroke-linecap="round"
    stroke-miterlimit="10" stroke-width="var(--hora-icon-stroke)" stroke-linejoin="round"></circle>
    ...
    stroke-width="var(--hora-icon-stroke)" stroke-linejoin="round"></path>
  </svg>
</template>